...
<div class="lead-form-page">
    ...
    <div class="form-page-header">
        ...
        <div>
            ...
            <p>
                Perbarui informasi calon pelanggan.
            </p>
        ...
        >
            ...
            <div class="form-section">
                ...
                <div class="section-heading">
                    ...
                    <p>
                        Perbarui informasi dasar calon pelanggan.
                    </p>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            placeholder="Contoh: PT Maju Textile"
                            required
                        >
                    ...
                    <div class="form-group">
                        ...
                        >
                            ...
                            <option
                                value="Website"
                                {{ old('source', $lead->source) === 'Website'
                                    ? 'selected'
                                    : ''
                                }}
                            >
                            ...
                            <option
                                value="Marketing"
                                {{ old('source', $lead->source) === 'Marketing'
                                    ? 'selected'
                                    : ''
                                }}
                            >
                            ...
                            <option
                                value="Referral"
                                {{ old('source', $lead->source) === 'Referral'
                                    ? 'selected'
                                    : ''
                                }}
                            >
            ...
            <div class="form-section">
                ...
                <div class="section-heading">
                    ...
                    <p>
                        Perbarui informasi tambahan mengenai lead.
                    </p>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full">
                        ...
                        <textarea
                            name="notes"
                            class="form-textarea"
                            placeholder="Informasi tambahan tentang lead..."
...
<script>
    ...
    document.addEventListener(
        ...
        function () {
            ...
            const leadForm =
                document.getElementById('leadEditForm');
            ...
            function validatePhone() {
                 ...
                 * Jika kosong, tidak dianggap error.
                 */
